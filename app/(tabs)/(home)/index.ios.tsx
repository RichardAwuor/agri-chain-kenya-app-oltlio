...
export default function HomeScreen() {
  ...
  const checkExistingUser = async () => {
    try {
      ...
      console.log('HomeScreen (iOS): Found stored user', { userId, userType, registrationCompleted });
      ...
      if (userId && userType) {
        ...
        try {
          ...
          console.log('HomeScreen (iOS): Fetched latest user data from backend', result);
          ...
          console.error('HomeScreen (iOS): Error fetching user data from backend:', error);
  ...
  const handleUserTypeSelect = async (userType: UserType) => {
    console.log('HomeScreen (iOS): User selected type:', userType);
    setSelectedUserType(userType);
    
    try {
      await AsyncStorage.setItem('userType', userType!);
      console.log('HomeScreen (iOS): Saved user type to storage');
      navigateToUserScreen(userType, 'new');
    } catch (error) {
      console.error('HomeScreen (iOS): Error saving user type:', error);
    }
  };
